export const PLACE_BOARD_ID = 'main';
...
export const PLACE_PLATES = Object.freeze([
    Object.freeze({ id: 'Q1', label: 'Top Left' }),
    Object.freeze({ id: 'Q2', label: 'Top Right' }),
    Object.freeze({ id: 'Q3', label: 'Bottom Left' }),
    Object.freeze({ id: 'Q4', label: 'Bottom Right' })
]);
